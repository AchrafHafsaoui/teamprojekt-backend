"""
Django settings for teamprojekt_backend project.
...
SECRET_KEY = 'django-insecure-=ce4wn%t0+r$h=$#unm&u7b^$jx5sh6nvpn8w2)=&=@l!#l&!z'
...
WSGI_APPLICATION = 'teamprojekt_backend.wsgi.application'
